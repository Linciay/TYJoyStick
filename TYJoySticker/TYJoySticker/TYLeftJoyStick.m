...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if ([self.delegate respondsToSelector:@selector(leftStickDidChangeValue:)])
    {
        [self.delegate leftStickDidChangeValue:self];
    }
}
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if ([self.delegate respondsToSelector:@selector(leftStickDidMoveEnd:)])
    {
        [self.delegate leftStickDidMoveEnd:self];
    }
}
